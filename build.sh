...
build_dtb() {
    ...
    cat "$(pwd)/out/arch/arm64/boot/dts/qcom/sm8150.dtb" \
        "$(pwd)/out/arch/arm64/boot/dts/qcom/sm8150-v2.dtb" \
...
build_dtbo() {
    ...
    echo "-----------------------------------------------"
    DTBO_FILES=$(find $(pwd)/out/arch/arm64/boot/dts/samsung/renovation -name sm8150-sec-r5q-overlay-*.dtbo)
