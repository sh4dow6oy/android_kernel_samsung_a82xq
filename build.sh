...
BUILD_VAR="-j$(nproc) O=${OUT_DIR} ARCH=arm64 CC=${CC} REAL_CC=${REAL_CC} CROSS_COMPILE=${CROSS_COMPILE} CLANG_TRIPLE=${CLANG_TRIPLE} LD=ld.lld HOSTLD=ld.lld LLVM=1 LLVM_IAS=1 KCFLAGS=-Wno-error"
